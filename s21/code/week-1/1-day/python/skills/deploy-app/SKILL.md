---
name: deploy-app
description: Деплой Python приложения в staging или production. Используй когда пользователь упоминает deployment, releases или environments.
compatibility: Requires bash, docker, и доступ к container registry
---

# Deploy App Skill

Используй этот навык для деплоя Python приложения в различные окружения.
...
- [ ] Changelog обновлен
- [ ] Environment variables настроены
- [ ] Alembic migration применена (если нужно)
